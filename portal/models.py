...
class Tae(models.Model):
    ...
    competencia_avaliacao = models.CharField(verbose_name='Avaliação online', max_length=150, blank=True, null=True)
    competencia_desenvolvimento = models.CharField(verbose_name='Desenvolvimento de Objetos de Aprendizagem', max_length=150, blank=True, null=True)
    competencia_design = models.CharField(verbose_name='Design Educacional (Instrucional)', max_length=150, blank=True, null=True)
    competencia_elaboracao = models.CharField(verbose_name='Elaboração de Projeto Pedagógico de Curso para EAD', max_length=150, blank=True, null=True)
    competencia_ensino = models.CharField(verbose_name='Ensino Híbrido', max_length=150, blank=True, null=True)
    competencia_plataforma = models.CharField(verbose_name='Plataforma Moodle ', max_length=150, blank=True, null=True)
    competencia_producao = models.CharField(verbose_name='Produção de livro-texto', max_length=150, blank=True, null=True)
    competencia_roteiro = models.CharField(verbose_name='Roteiro para vídeo aulas', max_length=150, blank=True, null=True)
    competencia_sala = models.CharField(verbose_name='Sala de aula invertida', max_length=150, blank=True, null=True)
    competencia_simulador = models.CharField(verbose_name='Simuladores e Ambientes de Imersão', max_length=150, blank=True, null=True)
    competencia_rnp = models.CharField(verbose_name='WebConferência RNP', max_length=150, blank=True, null=True)
